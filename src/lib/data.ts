...
export const mockNjangis: Njangi[] = [
    {
        ...
        members: [
            { id: "m1", name: "Amara Tanko", avatar: "AT", position: 5, hasPaid: true, isCurrentEater: false, phone: "+237 677 123 456", joinedAt: "2025-01-15", missedCycles: 0, penaltiesOwed: 0, consistencyScore: 100, isAdmin: true, country: "Cameroon" },
    ...
    },
    {
        ...
        conflictActive: true,
        members: [
            { id: "s1", name: "Amara Tanko", avatar: "AT", position: 2, hasPaid: false, isCurrentEater: false, phone: "+237 677 123 456", joinedAt: "2025-05-01", missedCycles: 0, penaltiesOwed: 0, consistencyScore: 100, isAdmin: false, country: "Cameroon" },
